...
public class StudentProgressionService {
  ...
  public double calculateAverage(String studentId) {
    ...
    return totalCoefficient == 0.0 ? 0.0 : totalWeightedScore / totalCoefficient;
  }
  ...
  public boolean hasGraduated(String studentId) {
    return calculateValidatedCredits(studentId) >= 180 && calculateAverage(studentId) >= 10.0;
  }
  ...
  private boolean isRetake(String type) {
    return type != null && (type.equalsIgnoreCase("RETAKE") || type.equalsIgnoreCase("RATTRAPAGE"));
  }
}
