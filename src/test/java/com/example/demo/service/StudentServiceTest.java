...
class StudentServiceTest {
    ...
    void shouldThrowExceptionWhenStudentNotFound() {
        ...
        RuntimeException exception =
                assertThrows(
                        ...
                        () -> studentService.getStudentById("unknown"));

        assertEquals(
                "Student not found with id: unknown",
    ...
    void shouldSaveStudentWithoutRelations() {
        ...
        ArgumentCaptor<JStudent> captor =
                ArgumentCaptor.forClass(JStudent.class);
    ...
    void shouldThrowExceptionWhenPromotionNotFound() {
        com.example.demo.model.Promotion promotion =
                com.example.demo.model.Promotion.builder()
                        .id("promotion-1")
                        .build();
        ...
        when(promotionRepository.findById("promotion-1"))
                .thenReturn(Optional.empty());
